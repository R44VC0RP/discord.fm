...
export function testConfig(root: string, overrides: Partial<AutomationConfig> = {}): AutomationConfig {
  return {
    ...
    crossfadeMs: 6000, badwords: ['forbidden phrase'], speechBadwords: ['speech-blocked'],
    hotlineEnabled: true, playoutEnabled: true, djEnabled: false, djShadow: false, aiArchiveEnabled: false,
    generationEnabled: false, hotlineImportEnabled: false, elevenLabsKey: '', elevenLabsVoiceId: '', elevenLabsModelId: 'eleven_multilingual_v2', elevenLabsSpeechSpeed: 0.92, elevenLabsBaseUrl: 'https://api.elevenlabs.io',
